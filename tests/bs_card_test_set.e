...
<div class="col-a_size-12"><div class="card"><img class="card-img-top"  alt="needs_alt_text"  src="a_img_src"/><div class="card-block"><h1 class="card-title">a_title</h1><p class="card-text">a_text</p><a class="btn btn-primary btn-md"  href="a_link"  role="button">a_link_text</a></div></div></div>
]"
